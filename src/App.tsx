...
function MainApp() {
  ...
  // If active user lacks admin access (e.g. CEO view), automatically redirect away from admin tab
  useEffect(() => {
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-canvas)] flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs font-mono text-[var(--text-metadata)]">Verifying Authentication Session...</p>
        </div>
      </div>
    );
  }
